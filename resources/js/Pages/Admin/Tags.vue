...
const submitForm = () => {
    if (form.value.id) {
        ...
        router.put(route('admin.tags.update', form.value.id), form.value, {
            onSuccess: () => {
        ...
        // Create new category
        router.post(route('admin.tags.add'), form.value, {
            onSuccess: () => {
                showModal.value = false;
                resetForm();
            },
...
const deleteTag = (id) => {
    if (confirm('Are you sure you want to delete this tag? This action cannot be undone.')) {
        router.delete(route('admin.tags.delete', id));
    }
};
</script>
        ...
        <Modal :show="showModal" @close="showModal = false">
            <div class="p-6">
                ...
                <div class="mt-6">
                    ...
                    <TextInput id="name" ref="nameInput" v-model="form.name" type="text" class="mt-1 block w-full" placeholder="Tag Name"/>
