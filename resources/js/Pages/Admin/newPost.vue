...
const addNewTag = async () => {
    ...
    try {
        ...
        // tagForm.post(route('admin.tags.save'), {
        //     onSuccess: (res) => {
        //         console.log("res:", res);
        //     },
        //     onError: (error) => {
        ...
        await axios.post(route('admin.tags.save'), { name: newTagName.value.trim()})
        .then((res) => {
            console.log("res:", res);
            const { data:newTag } = res.data;
        ...
        .catch((error) => {
            console.log("error:", error);
            newTagError.value = "An error occurred while trying to create a new Tag";
            setTimeout(() => newTagError.value = "", 5000);
